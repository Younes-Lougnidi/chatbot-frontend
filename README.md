...
- **Modern UI Components** - Material-UI for polished and professional look
...
```bash
git clone https://github.com/Younes-Lougnidi/chatbot-frontend.git
cd chatbot-frontend
npm install
```
...
- GitHub: [@Younes-Lougnidi](https://github.com/Younes-Lougnidi)
